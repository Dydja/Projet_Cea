<div class="multinav">
    <div class="multinav-scroll" style="height: 97%;">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
                <a href="{{ route('compte') }}">
                    <i class="ti-user"><span class="path1"></span><span class="path2"></span></i>
                    <span>Utilisateurs</span>
                </a>
            </li>
            <li>
                <a href="#">
                    <i class="icon-Group-folders"><span class="path1"></span><span
                            class="path2"></span></i>
           ...
           {{--  <li class="header">Components</li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="icons_cryptocoins.html"><i class="icon-Commit"><span
                                            class="path1"></span><span
                                            class="path2"></span></i>Cryptocoins Icons</a>
                            </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="component_portlet_draggable.html"><i class="icon-Commit"><span
                                            class="path1"></span><span
                                            class="path2"></span></i>Draggable Portlets</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="icon-Globe"><span class="path1"></span><span
                            class="path2"></span></i>
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="map_google.html"><i class="icon-Commit"><span
                                                    class="path1"></span><span
                                                    class="path2"></span></i>Google Map</a>
                                    </li>
                                    <li><a href="map_vector.html"><i class="icon-Commit"><span
                                                    class="path1"></span><span
                                                    class="path2"></span></i>Vector Map</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li><a href="component_sweatalert.html"><i class="icon-Commit"><span
                                                    class="path1"></span><span
                                                    class="path2"></span></i>Sweet Alert</a>
                                    </li>
        ...
        <div class="sidebar-widgets">
            <div class="mx-25 mb-30 pb-20 side-bx bg-primary-light rounded20">
                <div class="text-center">
                    <img src="https://crm-admin-dashboard-template.multipurposethemes.com/images/svg-icon/color-svg/custom-17.svg"
